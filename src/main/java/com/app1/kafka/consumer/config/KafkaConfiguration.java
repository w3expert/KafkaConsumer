package com.app1.kafka.consumer.config;
...
public class KafkaConfiguration {
    ...
    public ConsumerFactory<String, User> userConsumerFactory() {
        ...
        //config.put(JsonDeserializer.TRUSTED_PACKAGES,"com.app1.kafka.consumer.model");
        ...
        new DefaultKafkaConsumerFactory<>(config,
                ...
                new JsonDeserializer<>(User.class,
                        new ObjectMapper()
                //.registerModules(new KotlinModule(), new JavaTimeModule())
